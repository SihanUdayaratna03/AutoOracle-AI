    ...
    <div className="results-wrapper">
      ...
      <div className="market-analysis">
        <div className="price-range-banner">
          ...
          <div className="kpi-subtext" style={{ marginTop: '0.35rem' }}>
        ...
        <div>
          ...
          <div className="pill-container">
            {carAge <= 2 ? (
              ...
              <span className="factor-pill neutral">Moderate age · Average value</span>
            ) : (
            ...
            {formData.transmission === 'Automatic' && (
              <span className="factor-pill positive">Automatic · Premium</span>
            )}
